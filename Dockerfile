...
#   - Ex: docker.io/hexpm/elixir:1.19.1-erlang-28.1.1-debian-trixie-20251229-slim
#
...
# install npm dependencies for asset build tooling
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/triage ./
